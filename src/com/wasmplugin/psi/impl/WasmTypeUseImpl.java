...
public class WasmTypeUseImpl extends ASTWrapperPsiElement implements WasmTypeUse {

  public WasmTypeUseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WasmFuncType getFuncType() {
    return findChildByClass(WasmFuncType.class);
  }
