...
public class WastDataShortImpl extends ASTWrapperPsiElement implements WastDataShort {

  public WastDataShortImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WastVisitor visitor) {
    visitor.visitDataShort(this);
  }
