...
public class WastOffsetAbbrvImpl extends ASTWrapperPsiElement implements WastOffsetAbbrv {

  public WastOffsetAbbrvImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WastVisitor visitor) {
    visitor.visitOffsetAbbrv(this);
  }
  ...
  public WastInstruction getInstruction() {
    return findNotNullChildByClass(WastInstruction.class);
  }
