...
public class WastOffsetArgImpl extends ASTWrapperPsiElement implements WastOffsetArg {

  public WastOffsetArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WastVisitor visitor) {
    visitor.visitOffsetArg(this);
  }
