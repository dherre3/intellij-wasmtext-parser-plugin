...
public class WastParamExplicitImpl extends ASTWrapperPsiElement implements WastParamExplicit {

  public WastParamExplicitImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WastValueType getValueType() {
    return findNotNullChildByClass(WastValueType.class);
  }
