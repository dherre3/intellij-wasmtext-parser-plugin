...
public class WastElemTypeImpl extends ASTWrapperPsiElement implements WastElemType {

  public WastElemTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WastVisitor visitor) {
    visitor.visitElemType(this);
  }
