...
public class WastTableImpl extends ASTWrapperPsiElement implements WastTable {

  public WastTableImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WastElemShort getElemShort() {
    return findNotNullChildByClass(WastElemShort.class);
  }
  ...
  @Override
  @NotNull
  public WastTableType getTableType() {
    return findNotNullChildByClass(WastTableType.class);
  }
