...
public class WastTypeUseImpl extends ASTWrapperPsiElement implements WastTypeUse {

  public WastTypeUseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WastAbbrTypeUse getAbbrTypeUse() {
    return findNotNullChildByClass(WastAbbrTypeUse.class);
  }
