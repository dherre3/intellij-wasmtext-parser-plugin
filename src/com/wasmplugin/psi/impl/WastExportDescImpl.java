...
public class WastExportDescImpl extends ASTWrapperPsiElement implements WastExportDesc {

  public WastExportDescImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WastIdx getIdx() {
    return findNotNullChildByClass(WastIdx.class);
  }
