...
public class WastMemoryTypeImpl extends ASTWrapperPsiElement implements WastMemoryType {

  public WastMemoryTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WastVisitor visitor) {
    visitor.visitMemoryType(this);
  }
