...
public class WasmResultExplicitImpl extends ASTWrapperPsiElement implements WasmResultExplicit {

  public WasmResultExplicitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WasmVisitor visitor) {
    visitor.visitResultExplicit(this);
  }
