...
public class WasmImportShortImpl extends ASTWrapperPsiElement implements WasmImportShort {

  public WasmImportShortImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WasmVisitor visitor) {
    visitor.visitImportShort(this);
  }
