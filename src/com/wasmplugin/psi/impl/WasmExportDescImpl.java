...
public class WasmExportDescImpl extends ASTWrapperPsiElement implements WasmExportDesc {

  public WasmExportDescImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WasmIdx getIdx() {
    return findNotNullChildByClass(WasmIdx.class);
  }
