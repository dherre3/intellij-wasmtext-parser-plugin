...
public class WastResultImpl extends ASTWrapperPsiElement implements WastResult {

  public WastResultImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WastResultExplicit> getResultExplicitList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WastResultExplicit.class);
  }
