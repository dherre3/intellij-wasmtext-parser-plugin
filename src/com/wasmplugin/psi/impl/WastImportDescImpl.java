...
public class WastImportDescImpl extends ASTWrapperPsiElement implements WastImportDesc {

  public WastImportDescImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WastTableType getTableType() {
    return findChildByClass(WastTableType.class);
  }
