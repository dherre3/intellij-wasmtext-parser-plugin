...
public class WasmExportImpl extends ASTWrapperPsiElement implements WasmExport {

  public WasmExportImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WasmExportDesc getExportDesc() {
    return findNotNullChildByClass(WasmExportDesc.class);
  }
