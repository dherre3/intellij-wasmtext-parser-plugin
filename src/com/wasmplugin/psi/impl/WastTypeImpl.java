...
public class WastTypeImpl extends ASTWrapperPsiElement implements WastType {

  public WastTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WastFuncType getFuncType() {
    return findNotNullChildByClass(WastFuncType.class);
  }
