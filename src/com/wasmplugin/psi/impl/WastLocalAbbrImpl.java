...
public class WastLocalAbbrImpl extends ASTWrapperPsiElement implements WastLocalAbbr {

  public WastLocalAbbrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WastVisitor visitor) {
    visitor.visitLocalAbbr(this);
  }
