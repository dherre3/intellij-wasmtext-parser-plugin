...
public class WasmLocalImpl extends ASTWrapperPsiElement implements WasmLocal {

  public WasmLocalImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WasmLocalExplicit> getLocalExplicitList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WasmLocalExplicit.class);
  }
