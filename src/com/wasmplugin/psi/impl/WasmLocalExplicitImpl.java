...
public class WasmLocalExplicitImpl extends ASTWrapperPsiElement implements WasmLocalExplicit {

  public WasmLocalExplicitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WasmVisitor visitor) {
    visitor.visitLocalExplicit(this);
  }
