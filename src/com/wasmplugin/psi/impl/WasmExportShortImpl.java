...
public class WasmExportShortImpl extends ASTWrapperPsiElement implements WasmExportShort {

  public WasmExportShortImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WasmVisitor visitor) {
    visitor.visitExportShort(this);
  }
